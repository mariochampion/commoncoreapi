...
<html>
    <head>
        <title>standards.trails.by - common core parsing - asn_comment - <?php echo $component; ?></title>
	...
	<?php
		foreach( $json_array as $key=>$entity){
			...
			$dbaction->process_asncomment($entity['asn_comment'], $entity['id']);

			
			//please someone think of the children!
			if( 1 ){ echo "<br>findthechilds <br>"; }
			$dbaction->findthechilds($entity, 'asn_comment');
