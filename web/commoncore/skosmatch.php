...
<html>
    <head>
        <title>standards.trails.by - common core parsing - skos_exactMatch - <?php echo $component; ?></title>
	...
	<?php
		foreach( $json_array as $key=>$entity){
			...
			if( 1 ){ echo "<br>2 <br>"; }
				$dbaction->process_skos_exactMatch($entity['skos_exactMatch'], $entity['id']);
			}//end if
			
			//please someone think of the children!
			if( 1 ){ echo "<br>findthechilds <br>"; }
			$dbaction->findthechilds($entity, 'skos_exactMatch');
