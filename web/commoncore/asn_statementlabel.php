...
<html>
    <head>
        <title>standards.trails.by - common core parsing - asn_statementlabel - <?php echo $component; ?></title>
	...
	<?php
		foreach( $json_array as $key=>$entity){
			...
			$dbaction->process_asnstatementlabel($entity['asn_statementLabel'], $entity['id']);

			//please someone think of the children!
			if( 1 ){ echo "<br>findthechilds <br>"; }
			$dbaction->findthechilds($entity, 'asn_statementLabel');
